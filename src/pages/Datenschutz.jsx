        ...
        <section className="legal-section">
          ...
          <table className="legal-info-table">
            <tbody>
              ...
              <tr><td>E-Mail</td><td><a href="mailto:sales@cx8motion.com">sales@cx8motion.com</a></td></tr>
        ...
        <section className="legal-section">
          ...
          <div className="legal-table-wrap">
            <table className="legal-table">
              ...
              <tbody>
                <tr><td>Auskunft / Access</td><td>Art. 15 DSGVO</td><td><a href="mailto:sales@cx8motion.com">sales@cx8motion.com</a></td></tr>
                ...
                <tr><td>Einschränkung / Restriction</td><td>Art. 18 DSGVO</td><td><a href="mailto:sales@cx8motion.com">sales@cx8motion.com</a></td></tr>
